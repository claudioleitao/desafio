...
--
-- Host: localhost    Database: postomedicoveterinario
-- ------------------------------------------------------
...
CREATE TABLE `atendimento` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idmedicoveterinario` int(11) DEFAULT NULL,
  `idanimal` int(11) DEFAULT NULL,
  `urgencia` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_idx` (`idmedicoveterinario`),
  KEY `id_idx1` (`idanimal`),
  CONSTRAINT `fk_animal` FOREIGN KEY (`idanimal`) REFERENCES `animal` (`id`),
  CONSTRAINT `fk_veterinario` FOREIGN KEY (`idmedicoveterinario`) REFERENCES `medicoveterinario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-12 17:48:27
